...
[![Release](https://img.shields.io/github/v/release/ttallbamatuyu/web-scanner?style=for-the-badge&label=최신%20릴리즈)](https://github.com/ttallbamatuyu/web-scanner/releases/latest)
[![Download](https://img.shields.io/github/downloads/ttallbamatuyu/web-scanner/total?style=for-the-badge&label=총%20다운로드)](https://github.com/ttallbamatuyu/web-scanner/releases/latest)
[![Python](https://img.shields.io/badge/Python-3.10+-blue?style=for-the-badge&logo=python)](https://www.python.org/)
[![License](https://img.shields.io/badge/License-Educational%20Only-red?style=for-the-badge)](https://github.com/ttallbamatuyu/web-scanner)
...
> **파이썬 설치 없이 바로 실행 가능한 독립 실행 파일(.exe)을 제공합니다.**

**[👉 최신 버전 WebScanner.exe 다운로드](https://github.com/ttallbamatuyu/web-scanner/releases/latest)**
...
1. **[최신 릴리즈 페이지](https://github.com/ttallbamatuyu/web-scanner/releases/latest)** 에서 `WebScanner.exe`를 다운로드합니다.
2. 프로젝트 폴더 내의 **`start_server.bat`** 파일을 더블 클릭하여 훈련용 더미 서버를 켭니다. (창을 닫지 마세요)
3. 다운로드한 **`WebScanner.exe`** 를 실행합니다.
   > 참고: 개인 빌드 프로그램이므로 Windows Defender에서 경고가 뜰 수 있습니다. `추가 정보` → `실행`을 누르시면 됩니다.
4. GUI에서 필요 시 Cookie / Thread 수를 설정하고 **[Start Vulnerability Scan]** 버튼을 클릭하세요!

### 방법 2: 파이썬(Python) 환경에서 소스 코드 직접 실행

```bash
# 1. 레포지토리 클론
git clone https://github.com/ttallbamatuyu/web-scanner.git
cd web-scanner

# 2. 필수 라이브러리 설치
pip install -r requirements.txt

# 3. Playwright 브라우저 엔진 설치 (최초 1회만)
